...
<div class="container bg-light">
    ...
    <div id="<%=socio.getSocioId()%>" class="row mt-2 body">
        ...
        <div class="col-md-2 align-self-center text-center">
            <form class="d-inline" method="post" action="BorrarSociosServlet"> <!-- ESTO NOS INTERESA -->
                <input type="hidden" name="codigo" value="<%=socio.getSocioId() %>"/>
                <input class="btn btn-primary"  type="submit" value="Borrar">
            </form>
            <form class="d-inline" method="get" action="EditarSociosServlet"> <!-- ESTO NOS INTERESA -->
                <input type="hidden" name="codigo" value="<%=socio.getSocioId() %>"/>
